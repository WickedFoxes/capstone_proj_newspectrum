...
public class MainPageService {
    ...
    public int get_total_news_cnt(LocalDateTime start_date,
        ...
        List<NewsArticle> news_articles = news_article_repo.findAllByPeriod(start_date, end_date);
    ...
    public int get_total_news_cnt_by_domain(LocalDateTime start_date,
        ...
        Set<NewsArticle> cnt_set = new HashSet<>();
        for(NewsArticle newsArticle: news_articles){
            if(newsArticle.getDomain().equals(domain))
                cnt_set.add(newsArticle);
        }
        return cnt_set.size();
    }
    public int get_total_cluster_cnt(LocalDateTime start_date,
                                     LocalDateTime end_date){
        List<NewsCluster> news_clusters = news_cluster_repo.findNewsClusterByCreatedDate(start_date, end_date);

        Set<NewsCluster> cnt_set = new HashSet<>();
    ...
    public int get_total_cluster_cnt_by_domain(LocalDateTime start_date,
        ...
        Set<NewsCluster> cnt_map = new HashSet<>();
        for(NewsCluster cluster : news_clusters){
    ...
    public List<IssueDTO> get_issue(LocalDateTime start_date,
        ...
        Map<Long, NewsCluster> cluster_map = new HashMap<>();
